...
const ROWS = [
  [
    { title: "Programming Languages", items: ["C", "Python", "Java"] },
    { title: "Web Technologies", items: ["HTML", "CSS", "JavaScript", "React"] },
    { title: "Databases & Tools", items: ["MySQL", "Git"] },
    {title: "Frameworks", items: ["Spring Boot (basics)", "Hibernate (basics)"]},
  ],
  [
    {
      title: "Core Concepts",
    ...
    {
      title: "Soft Skills",
      items: ["Adaptability","Communication","Teamwork", "Problem Solving", "CRM",],
    },
  ],
];
    ...
    <section className="skills-container" id="skills">
      ...
      >
        ...
        <p className="text-gray-400 text-lg max-w-xl mx-auto">
         🚀 Turning ideas into code — explore my software expertise.
        </p>
      </motion.div>
