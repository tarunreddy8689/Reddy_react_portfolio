...
const IMAGES = {
  personal: [
    {
      id: 1,
      caption: "Lost in the serene beauty of devotion — where faith meets calm 🌫️✨",
      photos: ["/src/portfolio images/devotional.jpg", "/src/portfolio images/tirupathi.jpg"],
    },
    {
      id: 2,
      caption:
        "A weekend escape into nature 🌲 to clear my mind — because creativity blooms beyond the screen 🌄.",
      photos: ["/src/portfolio images/trip.jpg", "/src/portfolio images/goa.jpg"],
    },
  ],
  projects: [
    {
      id: 1,
      caption:
        "Designing beyond boundaries — where hardware performance meets software elegance.",
      photos: ["src/portfolio images/project.jpg", "/src/portfolio images/project 2.png"],
    },
  ],
  achievements: [
    {
      id: 1,
      caption: "Completed my Graduation 🏆!",
      photos: ["/src/portfolio images/graduation.jpg"],
    },
  ],
};
