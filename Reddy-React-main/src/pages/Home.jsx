...
// 🖼️ Import Assets
import photo from '../../src/assets/portfolio-images/portfolio.img.jpg'
...
export default function Home() {
  ...
  const quickLinks = [
    ...
    { img: linkedinLogo, title: 'LinkedIn', link: 'https://www.linkedin.com/in/tarun-kumar-reddy8689/' },
    { img: gmailLogo, title: 'Email', link: 'mailto:tarunkumarreddy6092@gmail.com' },   // ✅ FIXED
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Full Stack Web Developer | Frontend Developer | Java Developer
          </p>
          ...
          >
            {[
              ...
              { label: '💼 Expertise', value: 'Full Stack Web Developer,Problem solving' },
              { label: '📧 Contact', value: 'tarunkumareddy6092@gmail.com' },
            ].map((info, i) => (
              <motion.div
                key={i}
